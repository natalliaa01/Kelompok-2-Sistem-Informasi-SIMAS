...
$q = mysqli_query($conn, "SELECT * FROM masjid WHERE tipe='Mushalla' ORDER BY id DESC");
?>

<h1 class="text-2xl font-bold mb-6">Manajemen Data Mushalla</h1>

<a href="admin_masjid_add.php?tipe=Mushalla"
   class="bg-amber-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-amber-500">
   + Tambah Mushalla Baru
</a>
